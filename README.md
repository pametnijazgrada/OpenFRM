...
Finally, near the bottom of this section, you will find a number of additional outputs that will be generated if you have chosen to provide the detailed apartment typology.
...
Next, it may be interesting to move to the LCCA section (use the bottom tab). There you will find a multi-year summary of the performance of your project. While the level of detail here at first might seem intimidating, you quite quickly can start understanding the relation between certain choices you make regarding the setup of your project, and the financial impact they have. This is of course also crucial to review if a project will perform well for the group of residents that will be using it!

<img src="IMG/lcca.jpg" width="500">

## What data do you need to prepare for a useful assessment?

If you want to step beyond the first try-out of your project, you can enter more realistic data about it. The categories in this form (“prep list”) provide a good start. They are organised per sheet. Not all sheets are crucial at this stage to get an estimate - you can add more detail later. 
